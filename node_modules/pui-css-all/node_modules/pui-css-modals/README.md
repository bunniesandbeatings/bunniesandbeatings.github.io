...
A CSS modals component that can be installed via this npm package. The package provides all of the
...
You can find more examples of the modals component in the [pui style guide](http://styleguide.pivotal.io/objects.html#modal)
