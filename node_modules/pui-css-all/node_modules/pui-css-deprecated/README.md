...
A CSS deprecated component that can be installed via this npm package. The package provides all of the
CSS you need to use the component.

These CSS components have been slated for removal in the next major release.
...
```
npm install pui-css-deprecated
```
...
You can find more examples of the deprecated component in the [pui style guide](http://styleguide.pivotal.io)
